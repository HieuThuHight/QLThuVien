...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        String sql = "INSERT INTO nhacungcap (TenNCC, DiaChi, SDT, Email, NguoiLienHe) VALUES (?, ?, ?, ?, ?)";
        try (Connection conn = DBConnection.getConnection();
            ...
            stmt.setString(5, lienHe);
            int inserted = stmt.executeUpdate();
            message = inserted > 0 ? "Thêm nhà cung cấp thành công." : "Không thể thêm nhà cung cấp.";
    ...
    try (Connection conn = DBConnection.getConnection();
         PreparedStatement stmt = conn.prepareStatement("SELECT * FROM nhacungcap ORDER BY MaNCC DESC");
         ResultSet rs = stmt.executeQuery()) {
        while (rs.next()) {
            Map<String, Object> item = new HashMap<>();
            item.put("id", rs.getInt("MaNCC"));
            item.put("name", rs.getString("TenNCC"));
            item.put("address", rs.getString("DiaChi"));
            item.put("phone", rs.getString("SDT"));
            item.put("email", rs.getString("Email"));
            item.put("contact", rs.getString("NguoiLienHe"));
            suppliers.add(item);
        }
    } catch (SQLException e) {
        message = "Lỗi: " + e.getMessage();
...
<html>
    <head>
        ...
        <title>Nhà cung cấp - Thư viện UNETI</title>
        <style>
    ...
    <body>
        <div class="header">
            ...
            <div>
                ...
                <div style="font-size:24px; font-weight:bold;">NHÀ CUNG CẤP</div>
            </div>
        </div>
        <div class="nav">
            ...
            <a href="nhacungcap.jsp" class="active">Nhà cung cấp</a>
        ...
        <div class="container">
            ...
            <div class="grid">
                <div class="card">
                    ...
                    <table class="table">
                        <tr><th>#</th><th>Tên NCC</th><th>Địa chỉ</th><th>SDT</th><th>Email</th><th>Người liên hệ</th></tr>
                        <% if (suppliers.isEmpty()) { %>
                        <tr><td colspan="6">Không có nhà cung cấp.</td></tr>
                        <% } else {
                ...
                <div class="card">
                    ...
                    <form action="nhacungcap.jsp" method="POST">
                        <div class="form-field"><label>Tên NCC</label><input type="text" name="tenncc" required></div>
                        ...
                        <div class="form-field"><label>Người liên hệ</label><input type="text" name="lienhe"></div>
